...
datapath = {
    'cifar10': '/hpc/users/CONNECT/q18010301/ziqing/vision_transformer/Cifar10',
    'cifar100': '/hpc/users/CONNECT/q18010301/ziqing/vision_transformer/Cifar100'
...
def load_cv_data(data_aug, batch_size, workers, dataset, data_target_dir):
    ...
    if dataset == 'cifar10':
        ...
        train_data = datasets.CIFAR10(data_target_dir, train=True, transform=transform_train, download=True)
        test_data = datasets.CIFAR10(data_target_dir, train=False, transform=transform_test, download=True)
        ...
        train_data = datasets.CIFAR100(data_target_dir, train=True, transform=transform_train, download=True)
        test_data = datasets.CIFAR100(data_target_dir, train=False, transform=transform_test, download=True)
